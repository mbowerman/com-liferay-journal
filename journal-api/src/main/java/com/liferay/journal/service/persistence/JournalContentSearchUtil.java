...
public class JournalContentSearchUtil {
	...
	*/
	public static JournalContentSearch findByCompanyId_First(long companyId,
		OrderByComparator<JournalContentSearch> orderByComparator)
	...
	*/
	public static JournalContentSearch fetchByCompanyId_First(long companyId,
		OrderByComparator<JournalContentSearch> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchContentSearchException if a matching journal content search could not be found
	*/
	public static JournalContentSearch findByCompanyId_Last(long companyId,
		OrderByComparator<JournalContentSearch> orderByComparator)
		throws com.liferay.journal.exception.NoSuchContentSearchException {
		return getPersistence()
	...
	*/
	public static JournalContentSearch fetchByCompanyId_Last(long companyId,
		OrderByComparator<JournalContentSearch> orderByComparator) {
		return getPersistence()
	...
	*/
	public static JournalContentSearch[] findByCompanyId_PrevAndNext(
		...
		throws com.liferay.journal.exception.NoSuchContentSearchException {
		return getPersistence()
				   .findByCompanyId_PrevAndNext(contentSearchId, companyId,
			orderByComparator);
	}
